...
// router.get('/', withAuth, stayAccessController.getAllStayAccess);
...
// router.get('/:stay_id', withAuth, stayAccessController.getAccessByStay);
...
// Route pour ajouter un accès à un séjour
router.post('/add', validateAddStayAccess, validate, stayAccessController.addStayAccess);
