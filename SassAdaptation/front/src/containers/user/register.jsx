...
const Register = ({ onRegisterClick, onFieldFocus }) => {
    ...
    return (
        <article className="auth-face auth-right register-content">
            ...
            >
                <fieldset>
                    ...
                    {/* Prénom */}
                    <div className={`floating-input-container name-container ${focusedField === 'firstname' ? 'field-focused' : ''}`}>
                        <input
                            type="text"
                    ...
                    {/* Mot de passe */}
                    <div className={`floating-input-container password-container ${focusedField === 'password' ? 'field-focused' : ''}`}>
                        <input
                    ...
                    {/* Téléphone */}
                    <div className={`floating-input-container phone-container ${focusedField === 'phone' ? 'field-focused' : ''}`}>
                        <input
                            type="text"
                            id="register-phone"
                            name="register-phone"
