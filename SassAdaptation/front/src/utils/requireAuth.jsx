...
const RequireAuth = (props) => {
    ...
    // Extraction explicite de pageName des props
    ...
    // Rendre le composant enfant avec les paramètres ET le pageName
    return <Child {...props} params={params} pageName={pageName} />;
};
