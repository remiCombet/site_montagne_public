...
app.use(express.json({
  ...
  // Configuration améliorée pour express-fileupload avec gestion de l'encodage
  app.use(fileUpload({
      useTempFiles: true,
      tempFileDir: '/tmp/',
      debug: process.env.NODE_ENV === 'development',
      parseNested: true,
      safeFileNames: false, // Important: ne pas modifier les noms ici, nous le faisons dans notre service
      createParentPath: true,
      limits: { fileSize: 50 * 1024 * 1024 },
      // Options importantes pour l'encodage
      defCharset: 'utf8',
...
// route pour gérer l'envoi de mail avec emailJs (protéger les données, et clé api)
